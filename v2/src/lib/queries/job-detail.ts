...
/* ชื่อและลำดับหมวดไฟล์ย้ายไปอยู่ lib/file-categories.ts เพื่อให้ฝั่งเบราว์เซอร์ใช้ได้
 * ส่งต่อจากที่นี่เหมือนเดิม ที่อื่นที่ import อยู่แล้วจึงไม่ต้องแก้ */
export { FILE_LABELS, FILE_ORDER, fileLabel } from '@/lib/file-categories';
